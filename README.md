...
- [🌍 Awesome Large Weather Models (LWMs) | AI for Earth (AI4Earth) | AI for Science (AI4Science)](#-awesome-large-weather-models-lwms--ai-for-earth-ai4earth--ai-for-science-ai4science)
  ...
  - [🚀 Code](#-code)
## 🆕 LWMs News
- 2024/12/20: GraphDOP, a new data-driven, end-to-end forecast system developed at the European Centre for ECMWF that is trained and initialised exclusively from Earth System observations, with no physics-based reanalysis inputs or feedbacks [[link]](https://arxiv.org/abs/2412.15687).
